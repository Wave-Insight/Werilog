...
use super::continuous_assignment::net_assignment;
use super::ast::{BlockAssign, NonBlockAssign, VariableAssign, ProceduralContinuous};

/* TODO:wait for statement()
/// initial_construct ::= initial statement
pub fn initial_construct() -> impl Parser<Out = String> {
    token("initial") >> statement()
}

/// always_construct ::= always statement
pub fn always_construct() -> impl Parser<Out = String> {
